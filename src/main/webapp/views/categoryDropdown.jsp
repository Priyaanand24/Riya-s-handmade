        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="list-group">
                    <a href="categoryDropdown/101" class="list-group-item">jewellarys</a>
                    <a href="categoryDropdown/102" class="list-group-item">Bags</a>
                    <a href="categoryDropdown/103" class="list-group-item">Home Decors</a>
                </div>
            </div>
   <div class="col-md-9">;
